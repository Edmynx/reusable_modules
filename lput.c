/*
 * lput.c -- tests lput() function in list.c
 */
...
int32_t main() {
    ...
    /*
     * Put an object into the empty queue
     */
    result = lput(car1);
    if(result) {
    ...
    /*
     * Put an object into the non-empty queue
     */
    result = lput(car2);
    if(result) {
    ...
    /*
     * Put another object into the non-empty queue
     */
    result = lput(car3);
    if(result) {
